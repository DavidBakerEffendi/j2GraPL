...
class MethodInfoTest {
    lateinit var testModel: MethodInfo

    @BeforeEach
    fun setUp() {
        testModel = MethodInfo("Test", "za.ac.sun.grapl", 1)
    }

    @Test
    fun equalsTest() {
        val testModel1 = MethodInfo("Test", "za.ac.sun.grapl", 1)
        assertTrue(testModel == testModel1)
        assertTrue(testModel.hashCode() == testModel1.hashCode())
        val testModel2 = MethodInfo("Test1", "za.ac.sun.grapl", 1)
        assertFalse(testModel == testModel2)
        assertFalse(testModel.hashCode() == testModel2.hashCode())
        val testModel3 = MethodInfo("Test", "za.ac.sun.grapl.test", 1)
        assertFalse(testModel == testModel3)
        assertFalse(testModel.hashCode() == testModel3.hashCode())
        val testModel4 = MethodInfo("Test", "za.ac.sun.grapl", 2)
